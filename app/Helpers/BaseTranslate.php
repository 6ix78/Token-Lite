        ...
        $global = [
            ///// MESSAGES /////
              ...
              "messages.login.email_verify" => [
                "text" => "Please log in to verify your email address.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.mail.issues" => [
                "text" => "Unable to send email! Please check your mail setting credentials.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.permission" => [
               ...
               "messages.transfer.transaction_approved" => [
                "text" => "Payment received. Please wait up to 12 hours for token balance to update.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 0
               ],
            ...
            ///// AUTH /////
              ...
              "auth.recaptcha" => [
                  "text" => "Your request failed to complete. Bot detected.",
                  "pages" => "auth, global",
                  "panel" => "any",
                  "load" => 1
              ],
              "auth.health.save_action" => [
                  "text" => "Please register and activate the application to perform this action.",
                  "pages" => "auth, global",
                  "panel" => "any",
                  "load" => 1
              ],
            ...
            ///// AUTH PUBLIC /////
              ...
              "auth.forgot_password_note" => [
                "text" => "If you forgot your password, we'll email instructions to reset your account.",
                "pages" => "auth, global",
                "panel" => "any",
                "load" => 0
              ],
            ...
            ///// USER KYC FORM /////
              ...
              "kyc.form.paying_wallet_submit" => [
                "text" => "Submit the wallet address that you are going to send funds from",
                "pages" => "kyc",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// USER BUY TOKEN /////
              ...
              "buy_token.token_note" => [
                "text" => "Tokens will appear in your account up to 12 hours after payment successfully made and approved by our team. Please note that, :SYMBOL will be distributed after the token sales end-date.",
                "pages" => "buy_token",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// PAYMENT MANUAL CRYPTO /////
              ...
              "payment.deposit_address_or_scan" => [
                "text" => "Send payment to the following :Name Wallet Address Or scan the QR code",
                "pages" => "payment, manual",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "payment.agree_terms" => [
                "text" => "I hereby agree to the Terms and Conditions.",
                "pages" => "payment, manual",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "payment.review_desc" => [
                "text" => "We'll review your transaction and get back to you within 6 hours. You'll receive an email with the details of your contribution.",
                "pages" => "payment, manual",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// AUTH 2FA /////
              ...
              "auth.2fa.scan_qr_code" => [
                "text" => "Scan the below QR code with your Google Authenticator app, or you can add account manually.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "auth.2fa.contact_us" => [
                "text" => "If you lost your phone or uninstalled the Google Authenticator app, please contact us to recover your account.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "auth.2fa.reset_auth" => [
                "text" => "Please enter your password to reset 2FA authentication.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              "auth.2fa.invalid" => [
                "text" => "You have provided an invalid 2FA authentication code!",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "auth.2fa.enabled" => [
                "text" => "Successfully enabled 2FA Security.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
              "auth.2fa.disabled" => [
                "text" => "Successfully disabled 2FA security.",
                "pages" => "user_2fa",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// Transfer /////
              "transfer.send_token_friend" => [
                "text" => "Send Tokens to Your Friend",
              ...
              "transfer.you_do_not_have_token" => [
                "text" => "You do not have enough tokens to send.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
              "transfer.you_can_not_send_token_now" => [
                "text" => "You can not send tokens right now.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
              "transfer.enter_number_of_token" => [
                "text" => "Enter number of tokens you would like to send.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
              "transfer.please_enter_minimum" => [
                "text" => "Please enter minimum number of tokens.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
              "transfer.before_clicking_proceed" => [
                "text" => "Before clicking the &quot;Proceed&quot; button, be sure that you want to send tokens. You can not cancel the request once you proceed.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
              "transfer.can_not_send_token_to_friend" => [
                "text" => "Sorry! You can not send tokens right now. Please contact us if you have any question.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
              "transfer.invite_your_friend_send_token" => [
                "text" => "You can invite your friends to join OSIS and send them tokens via email.",
                "pages" => "transfer, transaction",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// Withdraw /////
              ...
              "withdraw.received_withdraw_request" => [
                "text" => "We have received your withdraw request and our team will proceed shortly. We will send you an email once we have completed it.",
                "pages" => "withdraw, transaction",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "withdraw.do_not_have_token_to_withdraw" => [
                "text" => "You do not have enough tokens to withdraw.",
                "pages" => "withdraw, transaction",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "withdraw.withdraw_funds_process" => [
                "text" => "You can withdraw your funds and we will process within 24hrs.",
                "pages" => "withdraw, transaction",
                "panel" => "user",
                "load" => 0
              ],
              ...
              "withdraw.withdraw_your_token_any_time" => [
                "text" => "You can withdraw your OSIS any time. It will be processed within 24 hours after your withdraw request.",
                "pages" => "withdraw, transaction",
                "panel" => "user",
                "load" => 0
              ],
            ...
            ///// REFERRAL /////
              ...
              "referral.received_token" => [
                "text" => "You have received bonus tokens.",
                "pages" => "referral",
                "panel" => "user",
                "load" => 0
              ],
              // v1.1.4
              "referral.refered_by" => [
                "text" => "You were invited by :userid",
                "pages" => "referral",
                "panel" => "user",
                "load" => 0
              ] 
