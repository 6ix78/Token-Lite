...
class IcoController extends Controller
{
    ...
    public function update_settings(Request $request)
    {
        ...
        if ($type == 'token_details') {
            ...
            //v1.3.1
            $purchase_busd = isset($request->token_purchase_busd) ? 1 : 0;
            $purchase_ada = isset($request->token_purchase_ada) ? 1 : 0;
            $purchase_doge = isset($request->token_purchase_doge) ? 1 : 0;
            $purchase_sol = isset($request->token_purchase_sol) ? 1 : 0;
            $purchase_uni = isset($request->token_purchase_uni) ? 1 : 0;
            $purchase_link = isset($request->token_purchase_link) ? 1 : 0;
            $purchase_cake = isset($request->token_purchase_cake) ? 1 : 0;
            ...
            //v1.3.1
            Setting::updateValue('token_purchase_busd', $purchase_busd);
            Setting::updateValue('token_purchase_ada', $purchase_ada);
            Setting::updateValue('token_purchase_doge', $purchase_doge);
            Setting::updateValue('token_purchase_sol', $purchase_sol);
            Setting::updateValue('token_purchase_uni', $purchase_uni);
            Setting::updateValue('token_purchase_link', $purchase_link);
            Setting::updateValue('token_purchase_cake', $purchase_cake);
