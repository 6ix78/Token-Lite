        ...
        <div class="modal-content">
            ...
            <div id="base-body" class="popup-body-full">
                ...
                <div class="popup-header">
                    ...
                    <p>You can manage the currency what you want to use in our payment system. You can use one or multiple currencies from the below options.</p>
                </div>
                            ...
                            <div class="input-item">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-3 col-6">
                                        ...
                                        <label for="kyc-opt-hide">Hide</label>
                                    </div>
                                </div>
                            </div>
