        ...
        <div class="modal-content">
            ...
            <div class="popup-body-full pdt-1x pdt-sm-3x">
                <div class="popup-body-innr pdt-2-5x pdb-1x">
                    ...
                    <p>Manage the currencies you want to use in payment system. You can use one or multiple currencies from the below options.</p>
                </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm w-sm-38">
                                        <div class="input-item input-with-label">
                                            ...
                                            <span class="input-note input-note-danger">Important: If base currency is changed after any transaction, it may affect the calculation. Must update exchange rate accordingly after currency change.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row guttar-20px">
                            <div class="col-sm">
                                <div class="input-item input-with-label w-sm-76">
                                    ...
                                    <span class="input-note">Set how exchange rate calculates</span>
                                </div>
                            </div>
                        </div>
                    </div>
