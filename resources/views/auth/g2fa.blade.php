...
<div class="page-ath-form">
    ...
    <br>{{ __('Enter the verification code generated by your mobile authenticator app.') }}</p>
    ...
    <div class="form-note">
        {{ __('If you lost your phone or uninstalled the Google Authenticator app, please contact our support team.') }}
    </div>
</div>
