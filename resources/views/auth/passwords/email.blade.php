...
<div class="page-ath-form">
    ...
    <h2 class="page-ath-heading">{{ __('Reset password') }} <span>{{ __("Forgot your password? Don't worry, put your email below & we'll send instructions to reset it. Please check your junk inbox if you don't see it within a few minutes.") }}</span></h2>
