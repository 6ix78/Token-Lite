                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="topbar-logo">
                        <a href="{{ url('/')}}" class="site-brand">
                            ...
                            @else
                           <img height="40" src="https://osis.world/images/logo-light.png" srcset="http://osis.world/images/logo-light2x.png" alt="Freedom Token">
					   @endif
                        </a>
                    </div>
                    <ul class="topbar-nav">
...
@php
    ...
    $route_urls = [
        ...
        'transfer_action_url' => 'admin.ajax.transactions.update',
