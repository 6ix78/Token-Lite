...
<div class="form-step form-step1">
    <div class="form-step-head card-innr">
        <div class="step-head">
            ...
            <div class="step-head-text">
                ...
                <p>{{__('Basic  information is required for identification purposes.')}}</p>
            </div>
        </div>
    </div>{{-- .step-head --}}
    <div class="form-step-fields card-innr">
        <div class="note note-plane note-light-alt note-md pdb-1x">
            ...
            <p>{{__('Please type carefully. Once submitted, this form cannot be edited.')}}</p>
        </div>
        <div class="row">
    ...
    <div class="form-step-head card-innr">
        <div class="step-head">
            ...
            <div class="step-head-text">
                ...
                <p>{{__('To verify your identity, please upload high-quality scans or photos of your government-issued identification documents.')}}</p>
            </div>
        </div>
    </div>{{-- .step-head --}}
    <div class="form-step-fields card-innr">
        <div class="note note-plane note-light-alt note-md pdb-0-5x">
            <em class="fas fa-info-circle"></em>
            <p>{{__('Upload any of the following documents.')}}</p>
        </div>
        ...
        <div class="doc-upload-area">
            <p class="text-secondary font-bold">{{__('To avoid delays with verification, please double-check to ensure the requirements are fully met:')}}</p>
            <ul class="list-check">
            ...
            <div class="doc-upload doc-upload-d1">
                <h6 class="font-mid doc-type-title">{!! __('Upload :doctype Copy', ['doctype' => '<storng class="doc-type-name">'.$defaultDoc.'</storng>']) !!}</h6>
            ...
            <div class="doc-upload doc-upload-d2{{ (isset($default_docs['doc']) && $default_docs['doc'] == 'nidcard') ? '' : ' hide' }}">
                <h6 class="font-mid">{{ __('Upload ID Back Side') }}</h6>
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <div class="upload-box">
            ...
            <div class="doc-upload doc-upload-d3">
                <h6 class="font-mid">{{__('Upload a selfie holding up the ID')}}</h6>
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <div class="upload-box">
    ...
    <div class="form-step-head card-innr">
        <div class="step-head">
            ...
            <div class="step-head-text">
                ...
                <p>{{__('Enter external wallet address')}}</p>
            </div>
        </div>
    </div>{{-- .step-head --}}
    <div class="form-step-fields card-innr">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-item input-with-label">
                    <label for="swalllet" class="input-item-label">{{__('Select Wallet')}}</label>
                    <div class="input-wrap">
                        <select class="select-bordered select-bordered select-block" name="wallet_name" id="swalllet">
                            {!! $option !!}
                        </select>
                    </div>
                </div>
        ...
        @endif
        <div class="input-item input-with-label">
            <label for="token-address" class="input-item-label">{{ ($wallet_count ==1) ? __('Enter your :Name wallet address', ['name' => array_values($wallets)[0]]) : __('Enter your wallet address') }}</label>
            <div class="input-wrap">
                <input class="input-bordered" type="text" id="token-address" name="wallet_address" placeholder="{{__('Your personal wallet address')}}">
            </div>
...
<div class="form-step form-step-final">
    <div class="form-step-fields card-innr">
        ...
        <div class="input-item">
            <input class="input-checkbox input-checkbox-md" id="term-condition" name="condition" type="checkbox" data-msg-required="{{ __("You should read our terms and policy.") }}">
        ...
        @endif
        <div class="input-item">
            <input class="input-checkbox input-checkbox-md" id="info-currect" name="currect" type="checkbox" data-msg-required="{{ __("Confirm that all information is correct.") }}">
            <label for="info-currect">{{__('All the information I have entered is correct.')}}</label>
        </div>
        <div class="input-item">
            <input class="input-checkbox input-checkbox-md" id="certification" name="certification" type="checkbox" data-msg-required="{{ __("Certify that you are individual.") }}">
        ...
        @if($has_wallet)
        <div class="input-item">
            <input class="input-checkbox input-checkbox-md" id="tokenKnow" name="tokenKnow" type="checkbox" data-msg-required="{{ __("Confirm that you understand.") }}">
        ...
        <button class="btn btn-primary" type="submit">{{__('Submit Verification')}}</button>
    </div>{{-- .step-fields --}}
</div>
