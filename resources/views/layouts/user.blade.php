...
<!-- Google Tag Manager -->
		...
		})(window,document,'script','dataLayer','GTM-5WSLG76');
		</script>
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="topbar-logo" href="{{ url('/') }}">
                        <img height="40" src="https://osis.world/images/logo-light.png" srcset="https://osis.world/images/logo-light2x.png" alt="Freedom Token">
					    </a>
                    <ul class="topbar-nav">
                        <li class="topbar-nav-item relative">
                            ...
                            <script>
                                ...
                                window.localStorage.setItem('em', user.email || null);
                                window.localStorage.setItem('fn', user.name.split(' ')[0]);
                                window.localStorage.setItem('ln', user.name.split(' ')[1]);
                                window.localStorage.setItem('phone', user.mobile);
                                dataLayer.push({
                                    em: user.email || null,
                                    fn: user.name.split(' ')[0],
                                    ln: user.name.split(' ')[1],
            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li><a href="{{ route('user.token') }}"><em class="ikon ikon-coins"></em> {{__('Get OSIS')}}</a></li>
                        ...
                        <li><a href="{{ route('user.token.balance') }}"><em class="ikon ikon-my-token"></em> {{ __('My Wallet') }}</a></li>
                        @endif
                    ...
                    <ul class="navbar-btns">
                        ...
                        @else
                        <li><a href="{{ route('user.kyc') }}" class="btn btn-sm btn-outline btn-light"><em class="text-primary ti ti-files"></em><span>{{__('ID Verification')}}</span></a></li>
                        @endif
                    </ul>
                    @endif
                </div>{{-- .navbar-innr --}}
                ...
                <div class="aside sidebar-right {{ empty($col_side_cls2) ? $col_side_cls : $col_side_cls2 }}">
                    ...
                    <div class="account-info card">
                        <div class="card-innr">
							...
							<script> var copyTextarea = document.getElementById("wallet_address");
...
@endif
    ...
    <script type="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.8/clipboard.min.js"></script>
    @stack('footer')
