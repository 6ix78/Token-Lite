            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7 col-xl-6 text-center">
                    <div class="error-content">
                        ...
                        <h4 class="text-dark">Oops! How'd you get here?</h4>
                        <p>We are very sorry for inconvenience. It looks like you ended up in a page that has either been deleted or never existed.</p>
