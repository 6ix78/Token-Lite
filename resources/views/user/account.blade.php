...
<div class="content-area card">
    <div class="card-innr">
        ...
        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#personal-data">{{__('Personal')}}</a>
            </li>
            <li class="nav-item">
            ...
            <div class="tab-pane fade" id="password">
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-password">
                    ...
                    <div class="note note-plane note-danger pdb-2x">
                        <em class="fas fa-info-circle"></em>
                        <p>{{__('Password will be updated after email confirmation.')}}</p>
                    </div>
                    <div class="gaps-1x"></div>{{-- 10px gap --}}
                    <div class="d-sm-flex justify-content-between align-items-center">
                        <button type="submit" class="btn btn-primary">{{__('Update')}}</button>
...
<div class="content-area card">
    <div class="card-innr">
        ...
        <p>{!! __("Use Two-Factor Authentication to protect your account. Once activated, you will enter your password, & a special code with an authenticator app. If you do not already have an authenticator app (such as Google Authenticator or Duo Mobile for example), you can download one in your mobile or browser app stores. This acts as a firm layer of security against third party intruders.") !!}</p>
            ...
            <div class="popup-body">
                ...
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-2fa">
                    ...
                    <div class="pdb-1-5x">
                        ...
                        <p><strong>{{ __('Step 2:') }}</strong> {{ __('Scan the below QR code with your Google Authenticator app, or you can add account manually.') }}</p>
                        ...
                        <p class="text-danger"><strong>{{ __('Note:') }}</strong> {{ __('If you lose your phone or uninstall the Google Authenticator app, you will lose access to your account.') }}</p>
                    </div>
                    @else
                    <div class="pdb-1-5x">
                        <div class="input-item">
