        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="banner_img text-center">
                    <img src="website/assets/images/contact_img.png" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="comman_banner_content">
                    <h1>Get in Touch!</h1>
                    <strong class="d-block mt-md-3 mt-2">WE&apos;RE AN EMAIL AWAY</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container pb-lg-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                @endif
                <form class="row form-main needs-validation" onsubmit="setDataLayer()" id="contactUsForm" novalidate enctype="multipart/form-data" method="post" action="<?php echo action('WebsiteController@contactus') ?>">
                    @csrf
                    ...
                    <div class="col-12 text-center mt-md-4 mt-2">
                        <button class="comman_btns border-0" type="submit">SEND</button>
                    </div>
                </form>
                <script>
        
                function setDataLayer(){
                    let form = new FormData(document.forms.contactUsForm);
                    dataLayer.push({
        ...
        <div class="row solutions_outer mt-lg-3">
            <div class="col-md-6 my-md-0 my-4 broder-right">
                <div class="solutions_box text-center">
                    ...
                    <a href="https://osis.world/register" class="comman_btns mt-3 rounded" target="0">Sign Up</a>
                </div>
            </div>
            <div class="col-md-6 my-md-0 my-4">
                <div class="solutions_box text-center">
                    ...
                    <a href="become-a-ptb.php" class="comman_btns mt-3 rounded" target="0">Learn More</a>
                </div>
            </div>
        </div>
    </div>
