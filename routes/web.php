...
Route::any('/get-osis', 'WebsiteController@getOsis');
// Handle Main / Route
Route::get('/', 'WebsiteController@index');
Route::get('/about-us', 'WebsiteController@aboutus');
Route::get('/become-a-partner', 'WebsiteController@becomeapartner');
Route::get('/become-a-ptb', 'WebsiteController@becomeaptb');
Route::any('/contact-us', 'WebsiteController@contactus');
Route::any('/partners', 'WebsiteController@partners');

Route::get('/future-investing', 'WebsiteController@futureinvesting');
Route::get('/home', 'Auth\LoginController@checkLoginState')->name('home');
...
Route::prefix('user')->middleware(['auth', 'user', 'verify_user', 'g2fa'])->name('user.')->group(function () {
    ...
    Route::post('/contribute/stripe_payment', 'User\TokenController@stripePayment')->name('stripe_payment');
	Route::post('/contribute/payment', 'User\TokenController@payment')->name('payment');
    Route::any('/contribute/stripe', 'User\TokenController@stripe')->name('stripe');
...
Route::prefix('admin')->middleware(['auth', 'admin', 'g2fa', 'ico'])->name('admin.')->group(function () {
	...
	Route::any('/approve_refer', 'Admin\TransactionController@approve_refer');
